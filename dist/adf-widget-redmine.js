...
angular.module('adf.widget.redmine')
  .controller('editIssuesController', ["projects", "customQueries", "config", "$scope", "$sce", function (projects, customQueries, config, $scope, $sce) {
...
angular.module('adf.widget.easyredmine')
  .controller('easyEditIssuesController', ["projects", "customQueries", "config", "$scope", "$sce", function (projects, customQueries, config, $scope, $sce) {
...
angular.module('adf.widget.redmine').controller('editChartController', ["projects", "config", "chartDataService", "redmineService", "$scope", "$sce", function (projects, config, chartDataService, redmineService, $scope, $sce) {
...
angular.module('adf.widget.easyredmine').controller('easyEditChartController', ["projects", "config", "easyChartDataService", "easyRedmineService", "$scope", "$sce", function (projects, config, easyChartDataService, easyRedmineService,  $scope, $sce) {
  $scope.showIdealTooltip = $sce.trustAsHtml('<b>OPTIONAL</b><br>If checked displays an ideal line on the chart');
  $scope.assignedToTooltip = $sce.trustAsHtml('Get issues which are assigned to the given user ID. <b>me</b> (but not <b>&lt;me&gt;</b> or <b>&lt;&lt;me&gt;&gt;</b>) can be used instead an ID to fetch all issues from the logged in user. Leave empty if you want to see all issues.');
